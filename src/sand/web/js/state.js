...
export function bindElements() {
  Object.assign(els, {
    ...
    sqlInsertTable: document.getElementById("sql-insert-table"),
    sqlInsertColumn: document.getElementById("sql-insert-column"),
    sqlInsertTableBtn: document.getElementById("sql-insert-table-btn"),
    sqlInsertColumnBtn: document.getElementById("sql-insert-column-btn"),
